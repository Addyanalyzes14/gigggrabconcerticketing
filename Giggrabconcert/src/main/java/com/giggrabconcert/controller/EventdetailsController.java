 ...
 */
@WebServlet(asyncSupported = true, urlPatterns = { "/eventdetailsController" })
public class EventdetailsController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("WEB-INF/pages/admin/eventdetails.jsp").forward(request, response);
	}
